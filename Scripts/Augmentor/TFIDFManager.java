...
public class TFIDFManager {
	...
	public TFIDFManager(String targetTerm, String repoName, String indexFolder) {
		this.repoName = repoName;
		this.indexFolder = indexFolder;
		this.targetTerm = targetTerm;
	}

	public TFIDFManager(String repoName, String indexFolder) {
		this.repoName = repoName;
		this.indexFolder = indexFolder;
	...
	public TFIDFManager(String indexFolder) {
		this.indexFolder = indexFolder;
		this.keys = new HashSet<>();
		this.idfMap = new HashMap<>();
		this.tfMap = new HashMap<>();
	...
	public HashMap<String, Long> calculateTF() {
		...
		try {
			...
			System.err.println("Failed to read the index.");
			exc.printStackTrace();
		}
		return termFreqMap;
	}
	...
	public static void main(String[] args) {
		...
		boolean stem = false;
		String indexFolder = StaticData.INDEX_FOLDER;
		System.out.println(new TFIDFManager(repoName, indexFolder).calculateIDF());
